    	...
    	<form action="cadastroUsuario" method="post">
        	...
        	<div class="form-floating">
            	<input type="text" class="form-control" id="floatingName"
                	placeholder="Seu nome" name="name" value="${param.name}"> 
                <label for="floatingName">Nome</label>
        	</div>
        	<div class="form-floating">
            	<input type="email" class="form-control" id="floatingInput"
               	 	placeholder="name@example.com" name="email" value="${param.email}"> 
        	...
        	<div class="divLink">
        		Já tem um cadastro? <a href="login.jsp"> Faça Login! </a>
        	</div>

        	<c:if test="${mostrarAlertaErro}">
            	<div>
                	<p style="color: red; padding: 10px">Digite todos os dados para confirmar o envio!</p>
            	</div>
        	</c:if>
        	
        	<c:if test="${jaExiste}">
            	<div>
                	<p style="color: red; padding: 10px">Esse email já foi cadastrado, tente outro ou entre em sua conta!</p>
            	</div>
        	</c:if>
        	
        	<c:if test="${erroCadastro}">
            	<div>
                	<p style="color: red; padding: 10px">Página restrita a usuários cadastrados!</p>
            	</div>
        	</c:if>
    	</form>
	</main>
